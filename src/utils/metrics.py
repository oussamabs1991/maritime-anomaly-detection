...
class ModelEvaluator:
    ...
    def calculate_multiclass_auc(self, y_true: np.ndarray, y_proba: np.ndarray,
...
def test_metrics():
    ...
    results = evaluator.evaluate_model(
        y_true, y_pred, y_proba, class_names, "test_model"
    )
    ...
    evaluator.evaluate_model(
        y_true, y_pred2, y_proba2, class_names, "test_model_2"
    )
