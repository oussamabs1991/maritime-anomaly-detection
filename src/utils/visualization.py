...
class ModelVisualizer:
    ...
    def plot_feature_importance(self, importance_data: pd.DataFrame,
        ...
        bars = ax.barh(y_pos, top_features[importance_col], 
    ...
    def plot_model_comparison(self, comparison_data: pd.DataFrame,
        ...
        # Create bar plot
        bars = ax.bar(comparison_data['model'], comparison_data['value'],
    ...
    def plot_data_distribution(self, data: pd.Series, title: str = "Data Distribution") -> plt.Figure:
        """
        ...
        ax2.pie(value_counts.values, labels=value_counts.index, autopct='%1.1f%%',
               startangle=90, colors=plt.cm.Set3(np.linspace(0, 1, len(value_counts))))
