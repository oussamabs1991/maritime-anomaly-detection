...
class TrajectoryKalmanFilter:
    ...
    def process_all_trajectories(self, df: pd.DataFrame, 
        ...
        for i, chunk in enumerate(chunks):
            ...
            if not chunk_data.empty:
                ...
                smoothed_chunk = chunk_data.groupby(['MMSI', 'traj_id']).apply(
    ...
    def validate_smoothing_quality(self, df: pd.DataFrame) -> dict:
        ...
        logger.info(f"  Points with smoothing: {quality_metrics['smoothing_applied']} "
